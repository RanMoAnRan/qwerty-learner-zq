...
本仓库是基于 [RealKai42/qwerty-learner](https://github.com/RealKai42/qwerty-learner) 的二次开发版本，目标是在保留原有打字练词核心能力的前提下，完成更产品化的桌面端体验与后续商业化能力接入。

## 项目定位

- 面向键盘工作者的英文输入训练与词汇记忆工具
- 保留原有「按章节练习、即时反馈、结果统计、错题回顾」主流程
- 增加桌面端应用壳（侧边栏导航）与更完整的页面体系（文章、会员、支付、登录等）
