...
const PronunciationSwitcher = () => {
  ...
  const languagePronConfig = useMemo(() => LANG_PRON_MAP[currentDictInfo.language] || LANG_PRON_MAP.en, [currentDictInfo.language])
  const pronunciationList = useMemo(() => languagePronConfig.pronunciation, [languagePronConfig])

  useEffect(() => {
    const defaultPronIndex = currentDictInfo.defaultPronIndex ?? languagePronConfig.defaultPronIndex
